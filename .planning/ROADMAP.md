...
- [x] 01-01-PLAN.md — Evidence retention (`.gitignore` D-04) and the rescued 200-session run-A anchor record
...
- [x] 01-07-PLAN.md — `leaderboard.json` source of truth and the generated `LEADERBOARD.md` report
...
| 2. Expanded Dataset & Paraphrase Probe | 15/14 | Complete   | 2026-09-01 |
